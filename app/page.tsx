...
export default function Home() {
  ...
  function runAnalysis() {
    ...
    setResults(recommendations.map((x) => x.work)); // 画面下にカードとしても出す
    try {
  ...
  return (
    <div className="page">
      ...
      <main className="container">
        ...
        {isLoading ? (
          <div className="panel">
            <div className="small muted">読み込み中…（{loadingWorks ? "作品" : ""}{loadingWorks && loadingVod ? " / " : ""}{loadingVod ? "配信情報" : ""}）</div>
          </div>
        ) : null}
          ...
          <div className="modalOverlay" onClick={closeAnimeModal}>
            <div className="modalContent" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="modalCard">
                ...
                {selectedAnime.summary ? <div className="desc" style={{ marginTop: 12 }}>{shortSummary(selectedAnime.summary, 220)}</div> : null}
              </div>
      ...
      <style jsx global>{`
        ...
        * {
        ...
        .page {
          min-height: 100vh;
          background: radial-gradient(1200px 600px at 50% -10%, rgba(255, 255, 255, 0.08), transparent 55%),
